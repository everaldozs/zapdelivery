...
import { getDefaultRouteForRole } from '../lib/authMiddleware';
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.user) {
        setSuccess('Login realizado com sucesso! Aguarde...');
        
        // Aguardar o perfil ser carregado e redirecionar
        // O redirecionamento será feito automaticamente pelo useEffect
        setTimeout(() => {
          // Fallback caso o useEffect não funcione
          if (!profile) {
            // Usar rota padrão genérica se perfil não estiver carregado ainda
  ...
  // Loading da autenticação ou redirecionamento
